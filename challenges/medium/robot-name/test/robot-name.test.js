...
// Require and use seedrandom exactly as shown. This will override
// the built-in Math.random method so that it generates numbers that
// appear random in a predictable sequence. We need this feature to
// test certain aspects of the robot name generation.

let Robot = require('../lib/robot-name.js');
